export default function Home() {
  return (
    <main className="py-4 px-4">
      <div className="p-6 mb-3 shadow-lg rounded-lg bg-blue-400 text-gray-700 text-center dark:bg-gray-500 text-white">
      ...
      <div className="sm:p-2 shadow-lg rounded-lg bg-blue text-blue-700 text-center dark:bg-gray-500 text-white">
        <h2 className="text-l sm:font-semibold text-3xl dark:text-black">
